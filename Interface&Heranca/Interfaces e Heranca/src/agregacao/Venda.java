...
public class Venda {
	...
	//Construtor da classe, garante que ao instanciar, qualquer novo produto seja add em um ArrayList
	public Venda() {
	...
	public void concretizaVenda() {
		...
		for (Produto prod : this.produtos) {
			System.out.println("Nome produto " + prod.getNomeProduto() + " Valor produto " + prod.getPreco());
		}
